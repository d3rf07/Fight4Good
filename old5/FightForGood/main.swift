...
team1.members[0] = game.teamMembersSelection(rank: "first")
print("")
print("WELCOME \(team1.members[0].playerName), the \(team1.members[0].playerType)")
print("")

team1.members[1] = game.teamMembersSelection(rank: "second")
print("")
print("welcome \(team1.members[1].playerName), the \(team1.members[1].playerType)")
print("")

team1.members[2] = game.teamMembersSelection(rank: "third")
print("")
...
//print (currentCharacter.playerName)
team2.members[0] = game.teamMembersSelection(rank: "first")
print("")
print("welcome \(team2.members[0].playerName), the \(team2.members[0].playerType)")
print("")

team2.members[1] = game.teamMembersSelection(rank: "second")
print("")
print("welcome \(team2.members[1].playerName), the \(team2.members[1].playerType)")
print("")

team2.members[2] = game.teamMembersSelection(rank: "fird")
print("")
