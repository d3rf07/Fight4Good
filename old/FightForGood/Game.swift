...
//    //SplashScreen + Welcome
    ...
    func teamNameChoice(playerNumber:String) {
        
    print( playerNumber + ", choose your team name" )

    teamName = readLine()

    while teamName!.isEmpty {
        print("Team name is mandatory, please " + playerNumber + ", choose your team name")
        teamName = readLine()
        }
        

    print("\n\n ok, welcome team \(teamName!)\n\n\n")
    ...
    func teamMembersSelection() -> Characters {
        
        let currentCharacter = Characters(playerType: "playerType")
        
        print("\n\n Now you will have to select 3 characters from the 4 existing types\n")
        ...
        print(  "\n Ok now choose your character name" )
        ...
        case "Fighter" :
            currentCharacter.playerLife = 100
        case "Mage" :
            currentCharacter.playerLife = 100
        case "Colossus" :
            currentCharacter.playerLife = 200
        case "Dwarf" :
            currentCharacter.playerLife = 50
        case "Dragon" :
            currentCharacter.playerLife = 200
        ...
        /// Apply Weapon
            ...
            currentCharacter.playerWeapon?.playerType = currentCharacter.playerType
            
        default:
            break
        }
        
        print("\n\n ok, welcome \(currentCharacter.playerName), the \(currentCharacter.playerType) \n\n\n\n" )
